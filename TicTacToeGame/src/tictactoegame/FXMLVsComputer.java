...
public class FXMLVsComputer extends AnchorPane {

    Stage stage = TictactoeGame.stage;
     Stage st = new Stage();

    MainAi rob = new AI1();
      Mediawin mw = new Mediawin();
      Medialose ml = new Medialose();
     ...
     setId("AnchorPane");
      ...
      imageView.setImage(new Image(getClass().getClassLoader().getResource("images/bb.png").toExternalForm()));
       ...
       imageView0.setImage(new Image(getClass().getClassLoader().getResource("images/grid.png").toExternalForm()));
        ...
        backBtn.setLayoutY(6.0);
        backBtn.setMnemonicParsing(false);
        backBtn.setPrefHeight(34.0);
        backBtn.setPrefWidth(46.0);
        ...
        menuBar.setLayoutX(150.0);
        menuBar.setLayoutY(420.0);
        menuBar.setPrefHeight(34.0);
        menuBar.setPrefWidth(110.0);
        ...
        menuItem.setText("hard");

        menuItem0.setMnemonicParsing(false);
        menuItem0.setText("medium");

        menuItem1.setMnemonicParsing(false);
        menuItem1.setText("easy");
        //  getChildren().add(imageView);
        
        
        radioButton.setLayoutX(95.0);
        radioButton.setLayoutY(465.0);
        radioButton.setMnemonicParsing(false);
        radioButton.setText("Easy");
        radioButton.setFont(new Font("Times New Roman Bold", 14.0));
...
radioButton.selectedProperty().addListener(new ChangeListener<Boolean>() {
        ...
        radioButton0.setLayoutX(237.0);
        radioButton0.setLayoutY(465.0);
        radioButton0.setMnemonicParsing(false);
        radioButton0.setText("Medium");
        radioButton0.setFont(new Font("Times New Roman Bold", 14.0));
...
radioButton0.selectedProperty().addListener(new ChangeListener<Boolean>() {
        ...
        radioButton1.setLayoutX(412.0);
        radioButton1.setLayoutY(465.0);
        radioButton1.setMnemonicParsing(false);
        radioButton1.setText("Hard");
        radioButton1.setFont(new Font("Times New Roman Bold", 14.0));
                    ...
                    if (x == 0) {
                        ...
                        if (x > 100) {
                            ...
                            mw.start(st);
                                ...
                                Logger.getLogger(FXMLVsComputer.class.getName()).log(Level.SEVERE, null, ex);
                            }
                    }
                }
